<template>
  <aside
    class="scanline-overlay position-fixed overflow-hidden top-0 left-0 w-100 h-100 z-n1"
  ></aside>
  <!-- 走査線オーバーレイ --IGNORE -->
  ...
  <!-- 君も、斜線や市松模様を CSS で表現したことあるだろう。それと発想は一緒である。 -- IGNORE -->
  ...
  <!-- You've probably created diagonal lines or checkerboard patterns with CSS before. The idea is the same. --IGNORE -->
</template>
